...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    */
            ...
            if(mActiveCard!=null) {
                ...
                flingCardListener = new FlingCardListener(mActiveCard, mAdapter.getItem(0),
                        ROTATION_DEGREES, new FlingCardListener.FlingListener() {
                            ...
                            @Override
                            public void score1Exit(Object dataObject) {
                                mFlingListener.onScore1CardExit(dataObject);
                            }

                            @Override
                            public void score2Exit(Object dataObject) {
                                mFlingListener.onScore2CardExit(dataObject);
                            }

                            @Override
                            public void score3Exit(Object dataObject) {
                                mFlingListener.onScore3CardExit(dataObject);
                            }

                            @Override
                            public void score4Exit(Object dataObject) {
                                mFlingListener.onScore4CardExit(dataObject);
                            }

                            @Override
                            public void noScoreExit(Object dataObject) {
                                mFlingListener.onNoScoreCardExit(dataObject);
                            }
    ...
    public interface onFlingListener {
        ...
        void onScore1CardExit(Object dataObject);
        void onScore2CardExit(Object dataObject);
        void onScore3CardExit(Object dataObject);
        void onScore4CardExit(Object dataObject);
        void onNoScoreCardExit(Object dataObject);
